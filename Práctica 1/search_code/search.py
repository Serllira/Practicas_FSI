...
def Ramificacion_search(problem):
    return graph_search(problem, RamificacionQueue())

def RamificacionConSubestimacion_search(problem):
    return graph_search(problem, RamificacionConSubestimacionQueue(problem))
